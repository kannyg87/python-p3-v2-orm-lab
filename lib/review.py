...
class Review:
    ...
    def employee_id(self, employee_id):
        if isinstance(employee_id, int) and Review.exists(employee_id) and employee_id>0:
            self._employee_id = employee_id
        else:
            raise ValueError("employee_id must be an integer corresponding to a valid employee")
